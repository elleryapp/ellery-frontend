...
class Sidebar extends React.Component<any, any> {
  ...
  saveSidebarWidth() {
    const width = ReactDOM.findDOMNode(this.refs['sidebar']).clientWidth;
  ...
  render() {
    ...
    const sidebarStyle = Object.assign(defaultStyles.sidebar, this.props.styles.sidebar);
    const contentStyle = Object.assign(defaultStyles.content, this.props.styles.content);
    const overlayStyle = Object.assign(defaultStyles.overlay, this.props.styles.overlay);
    ...
    if (useTouch) {
      if (this.props.open) {
        ...
        const dragHandleStyle = Object.assign(defaultStyles.dragHandle, this.props.styles.dragHandle);
